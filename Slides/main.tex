...
\titlegraphic{\hfill\includegraphics[height=3.5cm]{MyLogo.pdf}}
% --------------------------------------------------------------->
% 自我介绍
% --------------------------------------------------------------->
% --------------------------------------------------------------->
...
\input{Content/课程介绍/课程介绍.tex} % 10 min

\section{第二节 \space 操作系统和编程语言} % 90 min
\input{Content/操作系统和编程语言/Python简介.tex} % 10min
\input{Content/操作系统和编程语言/三大系统.tex} % 30 min
\input{Content/操作系统和编程语言/SHELL以及环境变量.tex} % 15min
\input{Content/操作系统和编程语言/编译型语言与解释型语言.tex} %5min
\input{Content/操作系统和编程语言/IDE介绍.tex} % 1min
\input{Content/操作系统和编程语言/安装Python解释器.tex} % 10 min
\input{Content/操作系统和编程语言/安装和配置conda环境.tex} % 10 min
\input{Content/操作系统和编程语言/安装和配置JupyterLab.tex} % 10 min
\begin{frame}[standout] Q \& A! \end{frame}
\begin{frame}[standout] Thank you! \end{frame}

\section{第三节 \space Python基础知识} % 90 min
\input{Content/Python基础知识/HelloWorld.tex} %15min
\input{Content/Python基础知识/变量与数据类型.tex}
\input{Content/Python基础知识/运算符.tex}
\input{Content/Python基础知识/流程控制.tex}
\input{Content/Python基础知识/函数.tex}
\input{Content/Python基础知识/IO操作.tex}
\input{Content/Python基础知识/语法糖.tex}
\begin{frame}[standout] Q \& A! \end{frame}
\begin{frame}[standout] Thank you! \end{frame}

\section{第四节 \space Python进阶知识}
\input{Content/Python进阶知识/PyCharm的安装和配置.tex}
\input{Content/Python进阶知识/模块与包.tex}
\input{Content/Python进阶知识/异常处理.tex}
\input{Content/Python进阶知识/面向对象编程.tex}
\input{Content/Python进阶知识/继承和多态.tex}
\input{Content/Python进阶知识/PEP8规范.tex}
\input{Content/Python进阶知识/补充知识.tex}
\begin{frame}[standout] Q \& A! \end{frame}
\begin{frame}[standout] Thank you! \end{frame}


\section{项目实战一 FASTA与FASTQ}
\input{Content/项目实战一_FASTA与FASTQ/序列储存格式的介绍.tex}
\input{Content/项目实战一_FASTA与FASTQ/FASTQ文件的操作.tex}
\input{Content/项目实战一_FASTA与FASTQ/FASTA文件的操作.tex}
\begin{frame}[standout] Q \& A! \end{frame}
\begin{frame}[standout] Thank you! \end{frame}

\section{项目实战三 基因注释文件处理}
\input{Content/项目实战三 基因注释文件处理/基因注释与GTF和GFF文件的介绍.tex}
\input{Content/项目实战三 基因注释文件处理/GTF和GFF文件操作.tex}
\input{Content/项目实战三 基因注释文件处理/程序CLI化.tex}
\begin{frame}[standout] Q \& A! \end{frame}
\begin{frame}[standout] Thank you! \end{frame}

\section{项目实战五 支持多核计算程序的编写}
\input{Content/项目实战五 支持多核计算程序的编写/多进程与多线程.tex}
\input{Content/项目实战五 支持多核计算程序的编写/计算给定区域的FPKM_RPKM_CPM信号_多核版.tex}
\input{Content/项目实战五 支持多核计算程序的编写/多核程序的性能分析.tex}
\input{Content/项目实战五 支持多核计算程序的编写/Python执行效率优化与学习资源分享.tex}
\begin{frame}[standout] Q \& A! \end{frame}
\begin{frame}[standout] Thank you! \end{frame}
\end{document}
